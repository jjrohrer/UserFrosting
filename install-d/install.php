...
/* jjr ouch - having these hardcoded is a bit problematic.  A maintenance challenge.  And conflicts with the new recursive dir search
maybe we can give private files a different filename pattern so we can recognize them?
*/
$pages_entry = "INSERT INTO `".$db_table_prefix."pages` (`id`, `page`, `private`) VALUES
(1, 'userland/index.php', 0),
(2, 'userland/register.php', 0),
(3, 'userland/login.php', 0),
(4, 'userland/process_login.php', 0),
(5, 'userland/user_create_user.php', 0),
(6, 'userland/activate_account.php', 0),
(7, 'userland/forgot_password.php', 0),
(8, 'userland/resend_activation.php', 0),
(9, 'userland/user_resend_activation.php', 0),
(10, 'userland/user_reset_password.php', 0),
(11, 'userland/header-loggedout.php', 0),
(12, 'userland/jumbotron_links.php', 0),
(13, 'userland/account.php', 1),
(14, 'userland/logout.php', 1),
(15, 'userland/dashboard.php', 1),
(16, 'userland/user_update_account_settings.php', 1),
(17, 'userland/form-components.php', 1),
(18, 'userland/user_alerts.php', 1),
(19, 'userland/header.php', 1),
(20, 'userland/account_settings.php', 1),
(21, 'userland/load_current_user.php', 1),
(22, 'userland/user_load_permissions.php', 1),
(23, 'userland/load_permissions.php', 1),
(24, 'userland/load_site_pages.php', 1),
(25, 'userland/load_site_settings.php', 1),
(26, 'userland/dashboard_admin.php', 1),
(27, 'userland/site_pages.php', 1),
(28, 'userland/site_settings.php', 1),
(29, 'userland/update_site_settings.php', 1),
(30, 'userland/update_user.php', 1),
(31, 'userland/create_permission.php', 1),
(32, 'userland/update_permission.php', 1),
(33, 'userland/create_user.php', 1),
(34, 'userland/update_page_permission.php', 1),
(35, 'userland/delete_permission.php', 1),
(36, 'userland/load_users.php', 1),
(37, 'userland/admin_activate_user.php', 1),
(38, 'userland/users.php', 1),
(39, 'userland/user_details.php', 1),
(40, 'userland/create_update_display_user_form.php', 1),
(41, 'userland/update_user_enabled.php', 1),
(42, 'userland/admin_load_permissions.php', 1),
(43, 'userland/template-permissions-row.php', 1),
(44, 'userland/delete_user_dialog.php', 1),
(45, 'userland/load_user.php', 1),
(46, 'userland/delete_user.php', 1),
(47, 'userland/404.php', 0),
(48, 'userland/includes.php', 0);
";
